...
public class JsonConverter {
    ...
    public String convertListToJson(Object param) {
        try {
            ...
            log.log(Level.WARNING, "browser-task >> JsonConverter >> convertListToJson >> Exception:", e);
            return "[]";
        }
    }
    ...
    public String convertObjectToJson(Object param) {
        try {
            ...
            log.log(Level.WARNING, "browser-task >> JsonConverter >> convertObjectToJson >> Exception:", e);
            return "{}";
        }
    }
    ...
    public static <T> Optional<T> convertToObject(String json, Class<T> responseType) {
        try {
            ...
            log.log(Level.WARNING, MessageFormat.format("browser-task >> JsonConverter >> convertToObject >> request: {0} >> Exception:", json), e);
            return Optional.empty();
        }
    }
    ...
    public static boolean canConvertToJson(String json) {
        try {
            ...
            log.log(Level.WARNING, MessageFormat.format("browser-task >> JsonConverter >> convertStringToJsonString >> request: {0} >> Exception:", json), e);
            return false;
        }
    }
